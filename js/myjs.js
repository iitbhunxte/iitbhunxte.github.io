...
function createCARD(dataa){
  $('.cards').append(`
        ...
        <div class="card ${dataa["Year of admission"]+" "+dataa["Gender"]+" "+dataa["City"].toUpperCase()} show">
          <div class="cardimage">
...
var public_spreadsheet_url = 'https://docs.google.com/spreadsheets/d/e/2PACX-1vSoTczcwW_iVLlQDS7SgRmXATL4hJ_uSF_74mVBfNJHFeBiahuf3odVxdOIezpLeCDfdni6P3nuiCa6/pub?gid=743816688&single=true&output=csv';
